...
import type { EditRoleModalProps, ModulePermission, PermissionLevel } from '@/Modules/Usuarios/Types/UserTypes';
...
export const EditRoleModal: React.FC<EditRoleModalProps> = ({ roleId, isOpen, onClose }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    updateRole({ Id_Rol: roleId, Nombre_Rol: nombreRol, permisosIds });
    onClose();
  };
