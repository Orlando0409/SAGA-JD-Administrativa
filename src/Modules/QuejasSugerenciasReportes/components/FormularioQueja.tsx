// src/Modules/QuejasSugerenciasReportes/components/FormularioQueja.tsx
import { useState } from 'react';
import { useForm } from '@tanstack/react-form';
import { z } from 'zod';
import { useCreateQueja } from '../hook/HookContacto';
...
const FormularioQueja = () => {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      const validation = quejaSchema.safeParse(value);
          ...
          {(field) => (
            <div className="mb-4">
              ...
              <textarea
                ...
                onBlur={field.handleBlur}
                onChange={(e) => field.handleChange(e.target.value)}
                placeholder="Descripción de tu queja"
...
export default FormularioQueja;
