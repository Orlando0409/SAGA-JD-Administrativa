...
const EditModal: React.FC<EditModalProps> = ({ isOpen, onClose, persona }) => {
    const { updateAbonado } = useAbonados();
    ...
    const getDefaultValues = () => {
        ...
        if (tipo === 'abonado') {
            ...
            return {
                ...
                Apellido1: abonado.Apellido1,
                Apellido2: abonado.Apellido2 || '',
                Cedula: abonado.Cedula,
                Numero_Telefono: abonado.Numero_Telefono,
                Correo: abonado.Correo,
                Direccion_Exacta: abonado.Direccion_Exacta || '',
                Edad: abonado.Edad,
            };
    ...
    const form = useForm({
        ...
        onSubmit: async ({ value }) => {
            ...
            try {
                if (persona.tipo === 'abonado') {
                    const abonadoData = {
                        ...value,
                        Id_Abonado: (persona.datos as Abonado).Id_Abonado
                    };
                    await updateAbonado({
                        id: (persona.datos as Abonado).Id_Abonado,
                        abonado: abonadoData as Partial<Abonado>
                    });
                    showSuccess('Abonado actualizado exitosamente');
                } else {
                    // TODO: Implementar para afiliados cuando existan las funciones
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
                ...
                <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                    <form
                        ...
                        className="space-y-4"
                    >
                        {/* Campos para personas físicas (abonado y afiliado físico) */}
                        {(persona.tipo === 'abonado' || persona.tipo === 'afiliado-fisico') && (
                            <>
                        ...
                        <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
                            ...
                            >
                                Actualizar {persona.tipo === 'abonado' ? 'Abonado' : 'Afiliado'}
                            </button>
                        </div>
                    </form>
                </div>
